  ...
  <body>
	...
	<div style="padding: 10px;">
        ...
        <div id="modalDiv"></div>
                ...
                $incoming_orders = query("SELECT * FROM incoming_orders");
                ...
                if (isset($incoming_orders[0])) {
                    ...
                    foreach ($incoming_orders as $order_data) {
                        ...
                        echo "<th scope='col'>" . strtoupper($order_data['time_ordered']) . "</th>";
                        echo "<th scope='col'>$" . number_format($order_data['price'], 2, '.', '') . " USD</th>";
                        echo "<th><button type='button' class='btn btn-block btn-danger' onclick='finalizeOrder(" . $order_data['id'] . ")'>Finalize</button></th>";
                        echo "</tr>";
                        echo "</thead>";

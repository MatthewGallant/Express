  ...
  <body>
	...
	<div class="container">
        ...
        <?php
            ...
            if (isset($_GET['message'])) {
                if ($_GET['message'] == "add_success") {
                    ...
                    echo '<div class="alert alert-success alert-dismissible fade show" role="alert">';
                    echo 'The account has been updated successfully.';
                    echo '<button type="button" class="close" data-dismiss="alert">';
                    echo '<span aria-hidden="true">&times;</span>';
                    echo '</button>';
                    echo '</div>';
                } elseif ($_GET['message'] == "edit_failure") {
                    echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">';
                    echo 'An error occurred while trying to update the account.';
                    echo '<button type="button" class="close" data-dismiss="alert">';
                    echo '<span aria-hidden="true">&times;</span>';
                    echo '</button>';
                    echo '</div>';
        ...
        <div class="row">
            ...
            <div class="col"></div>
            <div class="col">
                <a href="add-manager.php" class="btn btn-<?php echo $theme_color; ?> btn-block">Add Account</a>
            </div>
        </div>
        ...
        $accounts = query("SELECT * FROM login");
            ...
            echo "<th scope='col'>Account Email</th>";
            echo "<th scope='col'>Account Name</th>";
            echo "<th scope='col'>Admin Access</th>";
            echo "<th scope='col'>Edit Account</th>";
            ...
            foreach($accounts as $account) {
                ...
                if ($account['permanent'] == "yes") {
                    echo "<td>Permanent Account</td>";
                    echo "<td>Permanent Account</td>";
                } else {
                    echo "<td><a href='edit-manager.php?id=" . $account['id'] . "' class='btn btn-block btn-" . $theme_color . "')'>Edit Account</a></td>";
                    echo "<td><button type='button' class='btn btn-block btn-danger' onclick='deleteManager(" . $account['id'] . ")'>Delete Account</button></td>";
                }
